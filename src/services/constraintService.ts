...
export function subscribeToDoctors(callback: (doctors: Record<string, Doctor>) => void, onError?: SnapshotErrorHandler) {
...
export function subscribeToTechnicians(callback: (techs: Record<string, Technician>) => void, onError?: SnapshotErrorHandler) {
